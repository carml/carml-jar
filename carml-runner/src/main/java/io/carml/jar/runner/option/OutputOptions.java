...
public class OutputOptions {
  ...
  @Option(names = {"-F", "-of", "--outformat"}, completionCandidates = OutputRdfFormats.class, defaultValue = "nq",
      order = OptionOrder.OUT_FORMAT_ORDER,
  ...
  @Option(names = {"-l", "--limit"}, order = OptionOrder.LIMIT_ORDER,
