...
import static io.carml.runner.prefix.Prefixes.INLINE_PREFIX_DECLARATION_SEPARATOR;
import static io.carml.runner.prefix.Prefixes.isInlinePrefixMapping;

import com.fasterxml.jackson.core.type.TypeReference;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.dataformat.yaml.YAMLMapper;
import io.carml.runner.input.FilePathResolver;
...
public class DefaultNamespacePrefixMapper implements NamespacePrefixMapper {
  ...
  private Entry<String, String> handlePrefixDeclaration(String prefixDeclaration, List<Path> prefixMappings) {
    return isInlinePrefixMapping(prefixDeclaration) ? handleInlinePrefixMapping(prefixDeclaration)
  ...
  private Entry<String, String> handleInlinePrefixMapping(String inlinePrefixMapping) {
    var split = inlinePrefixMapping.split(INLINE_PREFIX_DECLARATION_SEPARATOR, 2);
